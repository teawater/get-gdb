...
GDB_VERSION_LIST = ("6.1.1", "6.2.1", "6.3", "6.4", "6.5", "6.6",
                    ...
                    "7.8.2", "7.9", "7.9.1", "7.10", "7.10.1", "7.11",
                    "7.11.1", "7.12", "7.12.1", "8.0", "8.0.1", "8.1",
                    "8.1.1", "8.2", "8.2.1", "8.3", "8.3.1", "9.1")
...
if distro == "Ubuntu":
    install_packages(distro, ["gcc", "g++", "texinfo", "m4", "flex", "bison",
